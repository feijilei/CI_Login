    ...
    <div id="wrappermiddle">
        ...
        <div id="username_input">
            ...
            <div id="username_inputmiddle">
                ...
                <input type="text" name="username" id="url" placeholder="Username" value="<?php echo set_value('username'); ?>">
        ...
        <div id="submit">
            <input type="image" src="<?php echo base_url()."img/submit_hover.png"?>" id="submit1" name="submit" value="Sign In">
        </div>
        </form>
        <div id="links_left">
